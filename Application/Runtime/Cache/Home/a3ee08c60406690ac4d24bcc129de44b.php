		...
		<div class="container">
			<div class="row">
				<div class="col-md-10 col-md-offset-2">
					<img src="img/logo.png" style="margin-left: 4%;"/>
					...
					<div class="log-broad">
						...
						<div class="row ">
							...
							<div class="col-md-6 logtitle">
								<input type="text" name="userId" id="" value="" class="log-input"/>
							</div>
						</div>
						<div class="row ">
						...
						<div class="row ">
							...
							<div class="col-md-6 logtitle">
								<input type="text" name="userPassword" id="" value="" class="log-input"/>
							</div>
						</div>
						<div class="row ">
						...
						<div class="row" style="text-align: right;">
							<div class="col-md-4 col-md-offset-5">
								<input type="button" name="" id="" value="注册" class="log-button"/>
