	...
	<body>
		...
		<div id="myCarousel" class="carousel slide" style="margin-top: 60px;">
			...
			<div class="carousel-inner">
				...
				<div class="item">
					<img src="/bnuzbroadcast/Public/img/lunbo1.png" alt="第三张">
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="media">
							...
							<div class="media-right">
								<a href="#"><img src="/bnuzbroadcast/Public/img/middle1.png" class="media-object" style="margin-right: 20px;margin-top: 45px;"></a>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="media">
							<div class="media-left">
								<a href="#"><img src="/bnuzbroadcast/Public/img/middle2.png" class="media-object" style="margin-left: 20px;margin-top: 45px ;"></a>
							</div>
					...
					<div class="col-md-6">
						<div class="media">
							...
							<div class="media-right">
								<a href="#"><img src="/bnuzbroadcast/Public/img/middle3.png" class="media-object" style="margin-right: 20px;margin-top: 35px;"></a>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="media">
							<div class="media-left">
								<a href="#"><img src="/bnuzbroadcast/Public/img/middle4.png" class="media-object" style="margin-left: 20px;margin-top: 35px ;"></a>
							</div>
							<div class="media-body">
