		...
		<div id="myCarousel" class="carousel slide" style="margin-top: 60px;">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="img/lunbo1.png" alt="第一张">
				</div>
				<div class="item">
					<img src="img/lunbo1.png" alt="第二张">
				</div>
				<div class="item">
					<img src="img/lunbo1.png" alt="第三张">
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="media">
							...
							<div class="media-right">
								<a href="#"><img src="img/middle1.png" class="media-object" style="margin-right: 20px;margin-top: 45px;"></a>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="media">
							<div class="media-left">
								<a href="#"><img src="img/middle2.png" class="media-object" style="margin-left: 20px;margin-top: 45px ;"></a>
							</div>
					...
					<div class="col-md-6">
						<div class="media">
							...
							<div class="media-right">
								<a href="#"><img src="img/middle3.png" class="media-object" style="margin-right: 20px;margin-top: 35px;"></a>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="media">
							<div class="media-left">
								<a href="#"><img src="img/middle4.png" class="media-object" style="margin-left: 20px;margin-top: 35px ;"></a>
							</div>
							<div class="media-body">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 col-sm-4">
						<div class="media select" >
							<div class="media-heading">
								<img src="img/select1.png" class="img-responsive" alt="" />
							</div>
					...
					<div class="col-md-4 col-sm-4">
						<div class="media select">
							<div class="media-heading">
								<img src="img/select2.png" class="img-responsive" alt="" />
							</div>
							<div class="media-middle">
					...
					<div class="col-md-4 col-sm-4">
						<div class="media select">
							<div class="media-heading">
								<img src="img/select3.png" class="img-responsive" alt="" />
							</div>
							<div class="media-middle">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="media">
							<div class="media-heading">
								<img src="img/notice.png" class="img-responsive center-block" alt="" />
							</div>
		...
		<div class="tab4">
			<div class="container">
				...
				<div class="col-md-6 col-sm-12" style="padding: 0px;margin: 0;">
					<div class="col-md-6 col-sm-12"style="padding: 0px;margin: 0;">
						<img src="img/notice1.png" class="img-responsive center-block myImg"/>
					</div>
				...
				<div class="col-md-6 col-sm-12" style="padding: 0;margin: 0;">
					<div class="col-md-6 col-sm-12" style="padding: 0px;margin: 0;">
						<img src="img/notice2.png" class="img-responsive center-block myImg" />
					</div>
					<div class="col-md-6 col-sm-12 tab4-body center-block myImg_box" style="padding: 15px;">
				...
				<div class="col-md-6 col-sm-12" style="padding: 0px;margin: 0;">
					<div class="col-md-6 col-sm-12"style="padding: 0px;margin: 0;">
						<img src="img/notice3.png" class="img-responsive center-block myImg"/>
					</div>
					<div class="col-md-6 col-sm-12 tab4-body center-block myImg_box"style="padding: 15px;">
				...
				<div class="col-md-6 col-sm-12" style="padding: 0;margin: 0;">
					<div class="col-md-6 col-sm-12" style="padding: 0px;margin: 0;">
						<img src="img/notice4.png" class="img-responsive center-block myImg" />
					</div>
					<div class="col-md-6 col-sm-12 tab4-body center-block myImg_box" style="padding: 15px;">
